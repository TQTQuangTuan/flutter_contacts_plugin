...
public class SwiftHeligateContactPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "heligate_contact", binaryMessenger: registrar.messenger())
    let instance = SwiftHeligateContactPlugin()
